          ...
          Container(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [Color.fromARGB(255, 255, 0, 157), Color.fromARGB(255, 206, 121, 199)], // Gradien warna biru
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const CircleAvatar(
                  radius: 100,
                  backgroundImage: AssetImage("assets/images/lelin-26.jpg"), // Path to your profile picture
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        InkWell(
                          onTap: () => _launchURL('tel:+6282117302976'),
                          child: Row(
                        ...
                        const SizedBox(height: 10),
                        InkWell(
                          onTap: () => _launchURL('mailto:21061101@itg.ac.id'),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: const [
